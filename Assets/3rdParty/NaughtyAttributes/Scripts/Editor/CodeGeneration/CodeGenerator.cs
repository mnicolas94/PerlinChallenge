...
namespace NaughtyAttributes.Editor
{
	public class CodeGenerator : UnityEditor.Editor
	{
		...
		private static readonly string META_ENTRY_FORMAT = "_metasByAttributeType[typeof({0})] = new {1}();" + Environment.NewLine;
		private static readonly string DRAWER_ENTRY_FORMAT = "_drawersByAttributeType[typeof({0})] = new {1}();" + Environment.NewLine;
		private static readonly string GROUPER_ENTRY_FORMAT = "_groupersByAttributeType[typeof({0})] = new {1}();" + Environment.NewLine;
		private static readonly string VALIDATOR_ENTRY_FORMAT = "_validatorsByAttributeType[typeof({0})] = new {1}();" + Environment.NewLine;
		private static readonly string DRAW_CONDITION_ENTRY_FORMAT = "_drawConditionsByAttributeType[typeof({0})] = new {1}();" + Environment.NewLine;
