...
public class DictionaryPropertyDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (expanded)
        {
            ...
            var defKeyProp = property.FindPropertyRelative("defaultValue");
            r = GetNextRect(ref position);
            var w = EditorGUIUtility.labelWidth;
            var propRect = new Rect(r.xMin, r.yMin, w, r.height);
            EditorGUI.PropertyField(propRect, defKeyProp, GUIContent.none, false);
            ...
            if(GUI.Button(pRect, "+"))
            {
                AddKeyElement(keysProp, defKeyProp);
    ...
    private static void AddKeyElement(SerializedProperty keysProp, SerializedProperty defaultValue)
    {
        keysProp.arraySize++;
...
//                                    i = -1;
            ...
            case SerializedPropertyType.ObjectReference:
                {
                    prop.objectReferenceValue = defaultValue.objectReferenceValue;
                }
                break;
